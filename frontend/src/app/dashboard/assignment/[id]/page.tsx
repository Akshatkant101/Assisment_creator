  ...
  return (
    <div className="max-w-4xl mx-auto pb-24">
      ...
      <div className="bg-white rounded-[1.75rem] shadow-sm border border-gray-100 overflow-hidden print:shadow-none print:rounded-none" id="exam-paper">
        ...
        {/* Footer */}
        <div className="border-t border-gray-100 px-10 py-5 flex items-center justify-between text-xs text-gray-400 font-medium">
          <span>Due: {fmt(data.dueDate)}</span>
          <span className="flex items-center gap-1.5"><CheckCircle2 size={12} className="text-green-500" /> Generated by VedaAI</span>
          <span>Total: {data.totalMarks} marks</span>
        </div>
      </div>
    </div>
  );
